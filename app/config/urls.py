...
from faq.views import vote_knn, vote_random_forest, vote_cosine_distance, FaqView, QuestionsApiView, FaqViewSet, RandomForecastViewSet, ReloadAppViewSet, CustomDataViewSet
...
urlpatterns = [
    ...
    path('api/<username>/faq/', CustomDataViewSet.as_view(), name='reload'),
]
